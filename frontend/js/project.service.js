...
.factory('ProjectData', function() {
  ...
  service.projects = [
    ...
    },
    {
      ...
      "date": 2015,
      "description": "The Milky Web is a project created as a commentary on raising children in a tech-focused world. The idea stems from the concern that young children are missing out on important human connections and socialization, and, instead, relying heavily on the digital for entertainment and connection. Poster printed on Paper. 90cm x 128cm.",
      "web": false,
      "design": true,
      "print": true,
      "technology": ["Adobe Illustrator", "Adobe Photoshop"]
